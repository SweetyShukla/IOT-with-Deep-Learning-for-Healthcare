...
y = heart_dataset.iloc[:, 13].values
...
classifier.add(Dropout(rate=0.05)) #Dropout p=0.05 means 10 percent of neurons in the first hidden layer will be randomly disabled, therefore, there will less chances of overfitting
